            ...
            <div className="site-option">
              <ul>
                <li className="currency">
                  <a href="#">USD <i className="fa fa-angle-down" /> </a>
              ...
              <div className="side-menu">
                ...
                <ul className="tab-navigation" role="tablist">
                  <li role="presentation" className="active">
                    <a href="#tab1" aria-controls="tab1" role="tab" data-toggle="tab">Women</a>
                  </li>
                  <li role="presentation">
                    <a href="#tab2" aria-controls="tab2" role="tab" data-toggle="tab">men</a>
                  </li>
                  <li role="presentation">
                    <a href="#tab3" aria-controls="tab3" role="tab" data-toggle="tab">Footwear</a>
                  </li>
                  <li role="presentation">
                    <a href="#tab4" aria-controls="tab4" role="tab" data-toggle="tab">Jewellery</a>
                  </li>
                  <li role="presentation">
                    <a href="#tab5" aria-controls="tab5" role="tab" data-toggle="tab">Accessories</a>
                  </li>
                  <li role="presentation">
                    <a href="#tab6" aria-controls="tab6" role="tab" data-toggle="tab">Dresses</a>
                  </li>
                  <li role="presentation">
                    <a href="#tab7" aria-controls="tab7" role="tab" data-toggle="tab">shoes</a>
                  </li>
                  <li role="presentation">
                    <a href="#tab8" aria-controls="tab8" role="tab" data-toggle="tab">Handbags</a>
                  </li>
                      ...
                      <div className="single-product">
                        ...
                        <div className="actions">
                          ...
                          <ul className="add-to-link">
                            <li>
                              <a className="modal-view" data-target="#productModal" data-toggle="modal" href="#">
          ...
          <div className="blog-post">
            <div className="single-blog-post">
              ...
              <div className="blog-content">
                ...
                <span><a href="#">By plaza themes - </a>17 Aug 2015 ( 0 comments
                  )</span>
                <p>
            ...
            <div className="twitter-feed">
              <div className="twitter-article">
                ...
                <div className="twitter-text">
                  <p>
                    Raboda Fashion #Magento #Theme comes up with pure white
                    and grey, which great show your products. Check it:
                  </p>
      ...
      <div className="row">
        <div className="col-sm-6">
          <div className="footer-copyright">
            <p>
              Copyright © 2016 <a href="#"> Bootexperts</a>. All Rights
              Reserved
            </p>
          </div>
        </div>
            ...
            <div className="modal-product">
              ...
              <div className="product-info">
                ...
                <div className="price-box">
                  <p className="price">
                    <span className="special-price"><span className="amount">$132.00</span></span>
                  </p>
                </div>
